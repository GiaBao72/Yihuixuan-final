      ...
      <div className="ps-wrap">
        ...
        <div className="ps-left ps-desktop-only">
          <div className="ps-header">
            <div className="sec-label anim">{lang === 'vi' ? 'Dòng sản phẩm' : lang === 'zh' ? '产品系列' : 'Product Line'}</div>
            <h2 className="sec-title anim" style={{ marginBottom: 0 }}>
              {lang === 'vi' ? 'Giải pháp laser ' : lang === 'zh' ? '激光解决方案 ' : 'Complete Laser '}<em>{lang === 'vi' ? 'toàn diện' : lang === 'zh' ? '全面' : 'Solutions'}</em>
            </h2>
          </div>
